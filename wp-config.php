...
define('DB_NAME', 'gmarquitectos');

/** MySQL database username */
define('DB_USER', 'root');

/** MySQL database password */
define('DB_PASSWORD', 'fran21');
...
define('WP_HOME','http://localhost/flydevs/gmarquitectos');
define('WP_SITEURL','http://localhost/flydevs/gmarquitectos');
