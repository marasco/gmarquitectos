...
Contact form plugin stores all form submissions in entries so you can view,edit or delete them. Entries also allow you to export your form submissions.

= Export Submissions = 

Contact form plugin have built in entries system which stores form submissions and allow you to print or export form submissions as CSV file. This format is supported by all CRM services for importing data to their platform.
...
Contact form plugin is 100% responsive and mobile friendly contact form plugin is compatible with Mobiles,Tablets & and all screen sizes. 



= Notifications = 

Contact form notification section allows you to select notifications for your submission get notified by email or select an AddOn for various email marketing service integrations. Recieve email notifications whenever someone use your contact form.


= Drag & Drop  From Builder =

Contact form plugin have drag and drop form builder which allows you to make and publish your forms in no time.
...
= How can I add my Contact Form in widget section ? =  
